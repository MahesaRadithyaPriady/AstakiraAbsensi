...
<body class="min-h-screen bg-off-white">
    <div class="flex min-h-screen">
        ...
        <div class="relative hidden w-1/2 flex-col justify-between bg-navy p-12 lg:flex">
            ...
            <div class="relative z-10">
                <h1 class="text-3xl font-bold leading-tight text-white">Absensi PKL</h1>
                <p class="mt-3 max-w-sm text-slate-300">Catat kehadiran, kirim laporan kegiatan, dan pantau progres PKL Anda secara digital.</p>
                <div class="mt-8 flex items-center gap-6">
                    <div>
                        <p class="text-2xl font-bold text-white">QR Code</p>
                    ...
                    <div class="h-8 w-px bg-white/20"></div>
                    <div>
                        <p class="text-2xl font-bold text-white">Paperless</p>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="mb-8 flex items-center gap-3 lg:hidden">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400">Login Pengguna</p>
                    </div>
                </div>
                ...
                <p class="mt-8 text-center text-xs text-slate-400">
                    ...
                    <a href="{{ url('/administrator/login') }}" class="font-medium text-brand-blue hover:text-deep-blue">Login Admin</a>
                </p>
            </div>
        </div>
    </div>
