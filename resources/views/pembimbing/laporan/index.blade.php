...
@section('title', 'Laporan Anak PKL')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-navy sm:text-2xl">Laporan Kegiatan PKL</h1>
            <p class="mt-1 text-sm text-slate-500">Pantau laporan kegiatan harian anak PKL</p>
        </div>
        ...
        <div class="p-4">
            <form method="GET" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('pembimbing.laporan.index') }}" class="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-600 hover:bg-slate-50">
                        Reset
                    </a>
                </div>
            </form>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($laporans as $laporan)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('pembimbing.laporan.show', $laporan) }}"
                ...
                <div class="p-4 space-y-3">
                    ...
                    @if ($laporan->foto)
                        <div class="flex items-center gap-2 pt-1">
                            <span class="text-xs text-slate-400 mr-1">Foto:</span>
